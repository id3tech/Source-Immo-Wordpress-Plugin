    ...
    <div class="actions">
        <div class="si-part si-prevent-typography align-stretch si-part-info-request">
            <div class="si-part align-stretch si-part-info-request-button">
                <button type="button" class="si-button si-modal-trigger ng-isolate-scope"><span ng-show="request_sent == undefined"><i class="fal fa-envelope"></i> Envoyer un message</span></button>
            </div>
        </div>
    </div>
