<div class="list-filters" layout="column" layout-align="start stretch">
    ...
    <si-filter-group ng-model="model.filter_group"></si-filter-group>
    ...
    <script  type="text/ng-template" id="filter-group">
        ...
        <div>
            <div class="filters"  ng-repeat="filter in model.filters">
                <si-filter-item class="grid-row" ng-model="filter" on-remove="removeFromList(filter, model, 'filters')"></si-filter-item>
            ...
            <div class="subgroups" ng-repeat="group in model.filter_groups">
                ...
                <si-filter-group ng-model="group" ng-parent="model"></si-filter-group>
