<div class="info-request form">
    <div class="firstname input-container">
        ...
        <div class="input">
            <input type="text" data-ng-model="message_model.firstname" />
        </div>
    </div>

    <div class="lastname input-container">
        <label><?php _e('Last name', IMMODB) ?></label>
        <div class="input" data-ng-model="message_model.lastname">
            <input type="text" />
        </div>
    </div>
    ...
    <div class="phone input-container">
        ...
        <div class="input">
            <input type="text" data-ng-model="message_model.phone" />
        </div>
    </div>
    ...
    <div class="email input-container">
        ...
        <div class="input">
            <input type="text" data-ng-model="message_model.email" />
        </div>
    </div>
    ...
    <div class="subject input-container">
        ...
        <div class="input">
            <input type="text" data-ng-model="message_model.subject" />
        </div>
    </div>
