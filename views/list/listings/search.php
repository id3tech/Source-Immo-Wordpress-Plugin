    ...
    <!-- Cities -->
    <?php
    SourceImmo::view("list/listings/search/cities");
    ?>


    <!-- Price -->
    <?php
    SourceImmo::view("list/listings/search/price");
    ?>

    
    <!-- Category -->
    <?php
    SourceImmo::view("list/listings/search/categories");
    ?>


    <!-- Rooms -->
    <?php
    SourceImmo::view("list/listings/search/rooms");
    ?>
    ...
    <!-- Mores -->
    <?php
    SourceImmo::view("list/listings/search/other");
    ?>
