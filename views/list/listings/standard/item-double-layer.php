...
if(isset($configs)){
    ...
    if(isset( $configs->list_item_layout->image_hover_effect)) $scope_class[] = 'si-img-hover-' . $configs->list_item_layout->image_hover_effect;
    if(isset( $configs->list_item_layout->secondary_layer_effect)) $scope_class[] = 'si-layer-hover-' . $configs->list_item_layout->secondary_layer_effect;
    if(isset( $configs->list_item_layout->primary_layer_position)) $scope_class[] = 'si-primary-layer-' . $configs->list_item_layout->primary_layer_position;
