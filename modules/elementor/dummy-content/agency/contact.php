<div class="contact">
    ...
    <div class="actions">
        <div class="si-part si-prevent-typography align-stretch si-part-info-request">
            <div class="si-part align-stretch si-part-info-request-button"><button type="button" class="si-button si-modal-trigger ng-isolate-scope" ng-disabled="request_sent === true" data-target="information_request">
